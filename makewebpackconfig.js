...
module.exports = function (options) {
    ...
    if (options.env !== 'development' && options.env !== 'dev') {
        // Entry
        entry = [
            "babel-polyfill",
        ...
        plugins = [// Plugins for Webpack
            new webpack.optimize.UglifyJsPlugin({ // Optimize the JavaScript...
                compress: {
                    ...
                    //drop_console: true // Disabling this property, wil enable this again after testing gets over.
                }
            }),
        ...
        // Entry
        entry = [
            "webpack-hot-middleware/client?path=http://localhost:3082/__webpack_hmr",
